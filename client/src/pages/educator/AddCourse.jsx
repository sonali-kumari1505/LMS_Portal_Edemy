...
const AddCourse = () => {
  ...
  const [courseTitle, setCourseCTitle] = useState('')
...
<div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
  <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'> {/* ✅ flex-=col fixed */}

        <div className='flex flex-col gap-1'>
        <p>Course Title</p>
         
            <input onChange={e => setCourseCTitle(e.target.value)} value={courseTitle} type="text" placeholder='Type here' // ✅ fixed aria-placeholder
            className='outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500' // ✅ fixed = required
          />
        </div>
       ...
       <img className='max-h-10' src={image ? URL.createObjectURL(image) : ''} alt="" />
        ...
        <div className='flex flex-col gap-1'>
          ...
          <input
            ...
            min={0}
            max={100}
            className='outline-none md:py-2.5 py-2 w-28 rounded border border-gray-500'
            required
          />
        </div>
...
<div key={chapterIndex} className='bg-white border rounded-lg md-4'>
  <div className='flex justify-between items-center p-4 border-b'>
    ...
    <span className="text-gray-500"> {/* ✅ fixed clasName */}
     ...
     <div className='p-4'>
       {chapter.chapterContent.map((lecture, lectureIndex) => (
         <div key={lectureIndex} className='flex justify-between items-center mb-2'>
           ...
           <img src={assets.cross_icon} alt="" className='cursor-pointer mt-2' onClick={()=>{handleLecture('remove',chapter.chapterId,lectureIndex)}} />
         </div>
    ...
    <div className='mb-2'>
      ...
      />
       ...
       <div className='flex gap-2 my-4'>
         <p>Is Preview Free</p> {/* ✅ fixed label */}
         <input
           type='checkbox'
     ...
     <img
       onClick={() => setShowPopup(false)} // ✅ fixed
