    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'> {/* ✅ flex-=col fixed */}
        ...
        <div className='flex flex-col gap-1'>
          <p>Course Title</p>
          <input
            onChange={e => setCourseCTitle(e.target.value)}
            value={courseTitle}
            type="text"
            placeholder='Type here' // ✅ fixed aria-placeholder
            className='outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500' // ✅ fixed =
            required
          />
        </div>
