...
<div className="absolute top-0 left-0 w-full  -z-10 bg-gradient-to-b from-cyan-100/70 to-white"></div>
...
<div className='pt-5 '>
{
  courseData.courseContent.map((chapter, index) => (
    <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
      {/* toggle section for on click to get the  preview option of lectures */}
...
{lecture.isPreviewFree && <p className='text-blue-500 cursor-pointer' onClick={()=>{
  ...
  <p>{humanizeDuration(lecture.lectDuration * 60 * 1000, { units: ['h', 'm'] })}</p>
</div>
       </div>
     </li>
   ))}
 ...
 <div className='h-4 w-px bg-gray-500/40'></div>
  ...
  <div className='pt-6'>
    ...
    <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
      ...
      <li>Step-by-step, hands-n project guidance.</li>
      <li>Downloable resources and sourcecode.</li>
